...
public class GalirardoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "IF", "ELSE", "LOOP", 
			"FORLOOP", "RESPONSE", "OUT", "IN", "INT_KW", "FLOAT_KW", "BOOLEAN_KW", 
			"STRING_KW", "TRUE", "FALSE", "EQ", "NEQ", "LT", "GT", "LTE", "GTE", 
			"AND", "OR", "ID", "STRING", "NUMBER", "FLOAT", "LPAREN", "RPAREN", "LBRACE", 
			"RBRACE", "SEMI", "COMMA", "BAR", "ASSIGN", "DIGIT", "WS"
		};
	}
